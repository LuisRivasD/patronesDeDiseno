...
public class VentanaSubasta1 extends JFrame implements Observer, ActionListener
{   
    ...
    public VentanaSubasta1(ClaseObservadorSubasta observador)
    {
        ...
        titulo= new JLabel();
        titulo.setText("(Ventana SUBASTA 1)");
        ...
        ofertaIngresada3.setActionCommand("1");
        ...
        timer.schedule( new TimerTask()
        {
            public void run()
            {  
                if(miObservador.getVentanaAction().equals("1"))
                {
