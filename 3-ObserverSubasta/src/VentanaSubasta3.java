...
public class VentanaSubasta3 extends JFrame implements Observer, ActionListener
{   
    ...
    public VentanaSubasta3(ClaseObservadorSubasta observador)
    {
        ...
        titulo= new JLabel();
        titulo.setText("(Ventana SUBASTA 3)");
        ...
        ofertaIngresada3.setActionCommand("3");
        ...
        setSize(500,640);
        setTitle("Ventana SUBASTA 3");
        setLocation(1000, 160);
        setLayout(null);
        setVisible(true);
        ...
        timer.schedule( new TimerTask()
        {
            public void run()
            {  
                if(miObservador.getVentanaAction().equals("3"))
                {
                    ...
                    if(!aumentoOferta.getText().equals(""))
                    {
                       switch(idVentana){
                        case "1":
                            ...
                            break;
                        case "2":
                            cabezaOferta.setText("El cliente 2 ha superado tu oferta");
                            break;
                        } 
                    } 
                }
                ...
                {   
                    ...
                    switch(idVentana){
                        case "1":
                            ...
                            break;
                        case "2":
                            ganador.setText("El cliente 2 ha ganado el item :(");
                            break;
                        case "3":
